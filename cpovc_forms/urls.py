...
urlpatterns = [
    ...
    # bidirectional referral final form [NOTE: ID not place]
    re_path('bidirectionalreferralform/new/(?P<id>\d+)/', views.new_bidirectionalreferralform, name='new_bidirectionalreferralform')
